...
<form action="" method="POST">
	<table align="center" width="800px">
		<tr>
			<th colspan="3">Generator GenAde + Harvia</th>
		</tr>
		<tr>
			<td>Nama Table</td>
			<td>:</td>
			<td><select id="table_name" name="nmtable" required>
		...
		<tr>
			<td>Nama Title</td>
			<td>:</td>
			<td><input type="text" name="nmtitle" required></td>
		</tr>
