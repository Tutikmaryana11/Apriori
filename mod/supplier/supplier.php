			...
			echo"<form class='w3-small' method='POST' action='$act'>
				<table>
					<tr>
						...
						<td width='10px'>:</td>
						<td><input type='text' name='id' class='w3-input' placeholder='Tidak Perlu Diisi' value='"?><?php echo isset($c['kode_supplier']) ? $c['kode_supplier'] : '';?><?php echo"'"?> <?php echo isset($c['kode_supplier']) ? ' readonly' : ' ';?><?php echo" required readonly>
						</td>
					...
					<tr>
						...
						<td>:</td>
						<td><input type='text' name='nama_toko' class='w3-input' placeholder='Nama Toko Supplier' value='"?><?php echo isset($c['nama_toko']) ? $c['nama_toko'] : '';?><?php echo"' required>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>:</td>
						<td><input type='text' name='telepon' class='w3-input' placeholder='Nomor Telepon' value='"?><?php echo isset($c['telepon']) ? $c['telepon'] : '';?><?php echo"' required>
						</td>
					</tr>
					<tr>
