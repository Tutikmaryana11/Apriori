		...
		case 'form':
			...
			echo"<form class='w3-small' method='POST' action='$act'>
				...
				<table>
					...
					<tr>
						<td><label class='w3-label'>Laporan</label></td>
						<td>:</td>
						<td>
							<input type='checkbox' class='w3-check' name='master[]' value='lapstok' "?><?php echo !empty(in_array("lapstok", $akses_master)) ? 'checked' : '';?><?php echo"> 
							<label class='w3-validate'>Laporan Stok</label>

							<input type='checkbox' class='w3-check' name='master[]' value='laplaris' "?><?php echo !empty(in_array("laplaris", $akses_master)) ? 'checked' : '';?><?php echo"> 
							<label class='w3-validate'>Laporan Terlaris</label>
							<input type='checkbox' class='w3-check' name='master[]' value='lappenjualan' "?><?php echo !empty(in_array("lappenjualan", $akses_master)) ? 'checked' : '';?><?php echo"> 
							<label class='w3-validate'>Laporan Data Penjualan</label>
							<input type='checkbox' class='w3-check' name='master[]' value='lappembelian' "?><?php echo !empty(in_array("lappembelian", $akses_master)) ? 'checked' : '';?><?php echo"> 
							<label class='w3-validate'>Laporan Pembelian</label>
						</td>
					</tr>
