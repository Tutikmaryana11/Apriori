			...
			echo"<form class='w3-small' method='POST' action='$act'>
				<table>
					<tr>
						...
						<td width='10px'>:</td>
						<td><input type='text' name='id' class='w3-input' placeholder='Tidak Perlu Diisi' value='"?><?php echo isset($c['kode_pelanggan']) ? $c['kode_pelanggan'] : '';?><?php echo"'"?> <?php echo isset($c['kode_pelanggan']) ? ' readonly' : ' ';?><?php echo" required readonly>
						</td>
					...
					<tr>
						...
						<td>:</td>
						<td><input type='text' name='nama_pelanggan' class='w3-input' placeholder='Nama Pelanggan' value='"?><?php echo isset($c['nama_pelanggan']) ? $c['nama_pelanggan'] : '';?><?php echo"' required>
						</td>
					</tr>
					<tr>
						<td><label class='w3-label'>NOMOR TELP</label></td>
						<td>:</td>
						<td><input type='text' name='nomor_telp' class='w3-input' placeholder='Nomor Telepon' value='"?><?php echo isset($c['nomor_telp']) ? $c['nomor_telp'] : '';?><?php echo"' required>
						</td>
					</tr>
					<tr>
