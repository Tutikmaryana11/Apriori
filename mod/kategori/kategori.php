			...
			echo"<form class='w3-small' method='POST' action='$act'>
				<table>
					<tr>
						...
						<td width='10px'>:</td>
						<td><input type='text' name='id' class='w3-input' placeholder='Tidak Perlu Diisi' value='"?><?php echo isset($c['kategori_id']) ? $c['kategori_id'] : '';?><?php echo"'"?> <?php echo isset($c['kategori_id']) ? ' readonly' : ' ';?><?php echo" required readonly> 
						</td>
					...
					<tr>
						...
						<td>:</td>
						<td><input type='text' name='nama_kategori' class='w3-input' placeholder='Nama Kategori' value='"?><?php echo isset($c['nama_kategori']) ? $c['nama_kategori'] : '';?><?php echo"' required>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
