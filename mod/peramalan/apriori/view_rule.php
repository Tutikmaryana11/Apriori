...
<div class='w3-container w3-small w3-pale-green w3-leftbar w3-border-green'>
                <h4 style='margin-bottom:0;padding-bottom:0;'>Hasil Detail Rule Apriori</h4>
...
//            else{
            ...
            <a href="mod/peramalan/apriori/export/CLP.php?id_process=<?php echo $id_process; ?>" class="btn btn-primary" target="blank">
                Export PDF
            </a>
            <br>
            <table class='w3-table w3-striped w3-bordered w3-tiny w3-hoverable tbl'>
            ...
            echo "<table class='w3-table w3-striped w3-bordered w3-tiny w3-hoverable tbl'>
                    <tr>
                        <th>No</th>
                        <th>Item</th>
                        <th>Jumlah</th>
