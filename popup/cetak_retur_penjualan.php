...
<div class="w3-row">
	<div class="w3-col s6 w3-tiny">Nama Toko<br>
		Telp. Nomor Telp Toko
	</div>
...
<center><h5>BUKTI RETUR PENJUALAN</h5></center>
<?php
...
<div class="w3-row-padding w3-tiny">
	...
	<div class="w3-col s4">
		<div class="w3-border w3-padding" style="font-size:8px;text-align:justify;">
				* Barang yang sudah dibeli dapat dikembalikan<br>
				* Barang yang bisa dikembalikan adalah barang yang msih memiliki nota pembayaran
			<br>
